...
console.log(`The ${tyrannosaurus.name} weighed ${tyrannosaurus.weight}kg`);

// What was the diet of a velociraptor?
console.log(`The ${velociraptor.name} was ${velociraptor.diet}`);

// How long was a stegosaurus?
console.log(`The ${stegosaurus.name} was ${stegosaurus.length}m long`);
...
const universities = graduates.map((name) => name.university);
universities.sort();
